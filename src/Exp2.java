...
class Exp2 {
	...
	private static void UneCompilation(String nomDuSource) {
		try {
			...
			System.out.println("Recognition exception: " + re); // erreur de nature syntaxique détectée par le lexer ou
																// le parser
			// System.err.println dirige ses impressions sur une autre sortie et les
			// messages ont alors tendance à se superposer
